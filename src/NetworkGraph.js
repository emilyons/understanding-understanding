  ...
  useEffect(() => {
    const data = {
      ...
      links: [
        ...
        { source: "Who", target: "Is it standard or unstandard?", value: 1 },
        { source: "What", target: "What does it do?", value: 1 },
        { source: "What", target: "What is it dependent on?", value: 1 },
        {
          source: "What",
          target: "What would happen if you left it out?",
          value: 1,
        },
        {
          source: "What",
          target: "What errors would suggest a problem with this?",
          value: 1,
        },
        { source: "Where", target: "Where does it go?", value: 1 },
        {
          source: "Where",
          target: "Where are the things around it dependent on it?",
          value: 1,
        },
        {
          source: "When",
          target: "When does it need to go somewhere else?",
          value: 1,
        },
        {
          source: "When",
          target: "When will it look the same or different?",
          value: 1,
        },
        ...
        { source: "Why", target: "Why or why not?", value: 1 },
        {
          source: "Why",
          target:
        ...
        {
          source: "How",
          target: "How could we say it out loud in English?",
          value: 1,
        },
        { source: "How", target: "How does it work?", value: 1 },
        {
          source: "How",
          target: "How is it the same or different from related services?",
          value: 1,
        },
        {
          source: "How",
          target: "How does this relate to the rest of the code?",
          value: 1,
        },
      ],
    };
